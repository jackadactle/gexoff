...
public class SettingsText extends GexObject {
	
	BufferedImage text = Font.text02(English.SETTINGS_TEXT);

	public SettingsText(int x, int y, GexID id, GexMenuID menuID) {
		super(x, y, id, menuID);
