...
public class SettingsButton extends GexObject {
	
	int lx;
	int ly;

	public SettingsButton(int x, int y, GexID id, GexMenuID menuID) {
		super(x, y, id, menuID);
	...
	public void render(Graphics g) {
		try {
			BufferedImage button = ImageIO.read(new File("Resources/Buttons/SettingsButton.png"));
			g.drawImage(
				button, 
				lx, 
				ly, 
	...
	public void click(MouseEvent e, GexHandler handler) {
		GexInit.showMenu(GexMenuID.Settings, handler);
